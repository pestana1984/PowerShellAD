...
$from = "DoNotReply@empresa.com" 
$email1 = "mail@empresa.com"
$timeout = "60"
...
add-content $report  "<font face='tahoma' color='#003399' size='4'><strong>Teste de Active Directory</strong></font>" 
add-content $report  "</td>" 
...
#####################################Buscando todos Domain Control Server##################################################
